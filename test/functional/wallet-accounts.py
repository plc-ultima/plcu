...
class WalletAccountsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for account in accounts:
            ...
            txid = node.sendfrom("", address, amount_to_send)
        ...
        for i in range(len(accounts)):
            ...
            txid = node.sendfrom(from_account, to_address, amount_to_send)
            tx = node.gettransaction(txid)
            fees2.append(-(tx['fee']))
        ...
        # assert_equal(node.getbalance(""), expected_balance)  # TODO: !
        # assert_equal(node.listaccounts(), expected_account_balances)  # TODO: !
