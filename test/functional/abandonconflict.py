...
class AbandonConflictTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_in(txA, self.nodes[0].getrawmempool())
        txB = self.nodes[0].sendtoaddress(self.nodes[0].getnewaddress(), Decimal("10"))
        assert_in(txB, self.nodes[0].getrawmempool())
        txC = self.nodes[0].sendtoaddress(self.nodes[0].getnewaddress(), Decimal("10"))
        assert_in(txC, self.nodes[0].getrawmempool())
        ...
        outputs = {}
        outputs[self.nodes[0].getnewaddress()] = Decimal("24.21") # total 24.96
        outputs[GraveAddress()] = Decimal("0.75")
        signed2 = self.nodes[0].signrawtransaction(self.nodes[0].createrawtransaction(inputs, outputs))
        txABC2 = self.nodes[0].sendrawtransaction(signed2["hex"])

        # In mempool txs from self should increase balance from change
        newbalance = self.nodes[0].getbalance()
        assert_equal(newbalance, balance - Decimal("30") + Decimal("24.21"))
        balance = newbalance
        ...
        newbalance = self.nodes[0].getbalance()
        assert_equal(newbalance, balance - Decimal("24.21"))
        ...
        newbalance = self.nodes[0].getbalance()
        assert_equal(newbalance, balance - Decimal("10") - Decimal("14.998") + Decimal("24.21"))
        balance = newbalance
        ...
        inputs.append({"txid":txA, "vout":nA})
        outputs = {}
        outputs[self.nodes[1].getnewaddress()] = Decimal("9.69")
        outputs[GraveAddress()] = Decimal("0.3")
