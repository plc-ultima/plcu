...
class BitcoinTestFramework(object):
    """Base class for a plcultima test script.

    Individual plcultima test scripts should subclass this class and override the set_test_params() and run_test() methods.
    ...
    def main(self):
        ...
        parser.add_option("--nocleanup", dest="nocleanup", default=False, action="store_true",
                          help="Leave plcultimads and test.* datadir on exit or error")
        parser.add_option("--noshutdown", dest="noshutdown", default=False, action="store_true",
                          help="Don't stop plcultimads after the test execution")
        parser.add_option("--srcdir", dest="srcdir", default=os.path.normpath(os.path.dirname(os.path.realpath(__file__)) + "/../../../src"),
                          help="Source directory containing plcultimad/plcultima-cli (default: %default)")
        ...
        if not self.options.noshutdown:
            ...
            self.log.info("Note: plcultimads were not stopped and may still be running")
        ...
        with tempfile.SpooledTemporaryFile(max_size=2**16) as log_stderr:
            try:
                ...
                if expected_msg is None:
                    assert_msg = "plcultimad should have exited with an error"
                else:
                    assert_msg = "plcultimad should have exited with expected error " + expected_msg
    ...
    def enable_mocktime(self):
        ...
        # to Nov 22, 2022 + (201 * 90)
        self.mocktime = 1669107600 + (201 * 90)
    ...
    def _start_logging(self):
        ...
        if self.options.trace_rpc:
            rpc_logger = logging.getLogger("PLCUltimaRPC")
...
class ComparisonTestFramework(BitcoinTestFramework):
    ...
    Sets up some plcultimad binaries:
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          default=os.getenv("PLCULTIMAD", "plcultimad"),
                          help="plcultimad binary to test")
        parser.add_option("--refbinary", dest="refbinary",
                          default=os.getenv("PLCULTIMAD", "plcultimad"),
                          help="plcultimad binary to use for reference nodes (if any)")
