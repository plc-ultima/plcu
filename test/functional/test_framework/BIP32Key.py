...
class BIP32Key(object):
    ...
    def Address(self):
        ...
        addressversion = b'\x02\xD0\xA4' if self.testnet else b'\x02\xD0\xA8'
        vh160 = addressversion + self.Identifier()
        return b58encode_chk(vh160)

    def P2WPKHoP2SHAddress(self):
        ##
        ## Note: this function was not tested for PLCU
        ##
        ...
        prefix = b'\x02\xD0\xA5' if self.testnet else b'\x02\xD0\xA9'
        return b58encode_chk(prefix + address_bytes)
