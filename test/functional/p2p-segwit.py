...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_block_relay(self, segwit_activated):
        ...
        # PLC Ultima: Blocks with nVersion < VB_TOP_BITS are rejected
    ...
    def test_reject_blocks(self):
        self.log.debug ("\tTesting rejection of block.nVersion < BIP9_TOP_BITS blocks")
    ...
    def run_test(self):
        ...
        # PLC Ultima: Disable test due to occasional travis issue
