...
class P2PLeakTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Note: delete unsupported_service_bit5_node and unsupported_service_bit7_node from this test,
        # because they are actual only before August 1st 2018,
        # but genesis block in PLCU starts from 09 Dec 2018 (testnet and regtest)

        no_version_bannode = CNodeNoVersionBan()
        no_version_idlenode = CNodeNoVersionIdle()
        no_verack_idlenode = CNodeNoVerackIdle()

        no_version_bannode.log = self.log
        no_version_idlenode.log = self.log
        no_verack_idlenode.log = self.log
