...
const char* ScriptErrorString(const ScriptError serror)
{
    switch (serror)
    {
        ...
        case SCRIPT_ERR_BAD_SCRIPT:
            return "Bad script";
        case SCRIPT_ERR_BAD_CERTIFICATE:
            return "Bad plc certificate";
        case SCRIPT_ERR_BAD_SIGNATURES:
            return "Bad plc signatures";
        ...
        case SCRIPT_ERR_BAD_REWARD_ADDRESS:
            return "Bad reward, incorrect address";
        ...
        case SCRIPT_ERR_BAD_REWARD_DAILY:
            return "Bad reward, daily limit exceeded";
        case SCRIPT_ERR_MISSING_REQUIRED_OUTPUT:
