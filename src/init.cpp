...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-limitfreetx", strprintf(_("Limit free tx (limit transactions with zero fee) (default: %d)"), DEFAULT_LIMIT_FREE_TX));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/plcultima-project/plcultima>";
    const std::string URL_WEBSITE = "<https://plcultima.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("PLC Ultima version %s\n", FormatFullVersion());
}
