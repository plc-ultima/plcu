...
struct MainSignalsInstance {
    ...
    boost::signals2::signal<void (const CTransactionRef &, const CBlockIndex * ,
                                  int, const CValidationInterface::SyncTransactionReason & )> NotifyTransaction;
...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->NotifyTransaction.connect(boost::bind(&CValidationInterface::NotifyTransaction, pwalletIn, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3, boost::placeholders::_4));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->NotifyTransaction.disconnect(boost::bind(&CValidationInterface::NotifyTransaction, pwalletIn, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3, boost::placeholders::_4));
...
void UnregisterAllValidationInterfaces() {
    ...
    g_signals.m_internals->NotifyTransaction.disconnect_all_slots();
...
void CMainSignals::NotifyTransaction(const CTransactionRef & ptx, const CBlockIndex * pindex,
                               int posInBlock, const CValidationInterface::SyncTransactionReason & reason) {
    m_internals->NotifyTransaction(ptx, pindex, posInBlock, reason);
}
