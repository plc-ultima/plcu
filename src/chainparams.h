...
public:
    ...
    int countOfInitialAmountBlocks() const    { return consensus.countOfInitialAmountBlocks; }
    /** initial award blocks count */
    int countOfInitialAwardBlocks() const     { return consensus.countOfInitialAwardBlocks; }
    /** minimum granularity */
    int64_t minGranularity() const            { return consensus.minGranularity; }
    /** award granularity */
    int64_t awardGranularity(const uint32_t height) const;
...
typedef std::shared_ptr<CChainParams> CChainParamsPtr;
