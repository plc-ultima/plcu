...
//! -maxtxfee default
static const CAmount DEFAULT_TRANSACTION_MAXFEE = 0.001 * COIN;
...
bool AcceptToMemoryPool(CTxMemPool& pool, CValidationState &state, const CTransactionRef &tx, bool fLimitFree,
                        ...
                        bool fOverrideMempoolLimit=false, const CAmount nAbsurdFee=0, bool dryrun = false);
...
void UpdateCoins(const CTransaction& tx, CCoinsViewCache& inputs, int nHeight, unsigned int blockTime);
...
public:
    ...
    bool operator()(const CCoinsViewCache * view = nullptr);
