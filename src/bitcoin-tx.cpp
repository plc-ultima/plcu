...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s plcultima-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  plcultima-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded plcultima transaction") + "\n" +
              "  plcultima-tx [options] -create [commands]   " + _("Create hex-encoded plcultima transaction") + "\n" +
              "\n";
